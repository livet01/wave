<div class="admin-box">
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			<thead>
				<tr>
					<?php if ($this->auth->has_permission('Style.Content.Delete') && isset($records) && is_array($records) && count($records)) : ?>
			...
			<?php foreach ($records as $record) : ?>
				...
				<?php if ($this->auth->has_permission('Style.Content.Edit')) : ?>
				<td><?php echo anchor(SITE_AREA .'/content/style/edit/'. $record->sty_id, '<i class="icon-pencil">&nbsp;</i>' .  $record->sty_couleur) ?></td>
				<?php else: ?>
