...
class developer extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Style.Developer.View');
	...
	*/
	...
	{
		$this->auth->restrict('Style.Developer.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_style())
			{
				...
				Template::redirect(SITE_AREA .'/developer/style');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/developer/style');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Style.Developer.Edit');
		...
		{
			$this->auth->restrict('Style.Developer.Delete');
