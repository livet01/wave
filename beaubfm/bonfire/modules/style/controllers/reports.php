...
class reports extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Style.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('Style.Reports.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_style())
			{
				...
				Template::redirect(SITE_AREA .'/reports/style');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/style');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Style.Reports.Edit');
		...
		{
			$this->auth->restrict('Style.Reports.Delete');
