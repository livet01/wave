...
class content extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Style.Content.View');
	...
	*/
	public function index()
	{
		...
		Template::set('toolbar_title', 'Gérer les Styles');
		Template::render();
	}
	...
	*/
	...
	{
		$this->auth->restrict('Style.Content.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_style())
			{
				...
				Template::redirect(SITE_AREA .'/content/style');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Style.Content.Edit');
		...
		{
			$this->auth->restrict('Style.Content.Delete');
