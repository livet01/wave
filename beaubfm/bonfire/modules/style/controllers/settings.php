...
class settings extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Style.Settings.View');
	...
	*/
	...
	{
		$this->auth->restrict('Style.Settings.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_style())
			{
				...
				Template::redirect(SITE_AREA .'/settings/style');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/settings/style');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Style.Settings.Edit');
		...
		{
			$this->auth->restrict('Style.Settings.Delete');
