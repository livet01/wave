...
class developer extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Parametre.Developer.View');
	...
	*/
	...
	{
		$this->auth->restrict('Parametre.Developer.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_parametre())
			{
				...
				Template::redirect(SITE_AREA .'/developer/parametre');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/developer/parametre');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Parametre.Developer.Edit');
		...
		{
			$this->auth->restrict('Parametre.Developer.Delete');
