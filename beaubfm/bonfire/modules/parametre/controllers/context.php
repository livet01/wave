...
class context extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Parametre.Context.View');
	...
	*/
	...
	{
		$this->auth->restrict('Parametre.Context.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_parametre())
			{
				...
				Template::redirect(SITE_AREA .'/context/parametre');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/context/parametre');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Parametre.Context.Edit');
		...
		{
			$this->auth->restrict('Parametre.Context.Delete');
