...
class settings extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Parametre.Settings.View');
	...
	*/
	...
	{
		$this->auth->restrict('Parametre.Settings.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_parametre())
			{
				...
				Template::redirect(SITE_AREA .'/settings/parametre');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/settings/parametre');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Parametre.Settings.Edit');
		...
		{
			$this->auth->restrict('Parametre.Settings.Delete');
