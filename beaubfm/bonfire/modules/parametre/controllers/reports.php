...
class reports extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Parametre.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('Parametre.Reports.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_parametre())
			{
				...
				Template::redirect(SITE_AREA .'/reports/parametre');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/parametre');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Parametre.Reports.Edit');
		...
		{
			$this->auth->restrict('Parametre.Reports.Delete');
