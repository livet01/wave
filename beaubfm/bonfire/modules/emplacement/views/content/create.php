...
<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
    <fieldset>
        ...
        <div class="control-group <?php echo form_error('emplacement_rad_id') ? 'error' : ''; ?>">
            <?php echo form_label('Identifiant Radio : 1'. lang('bf_form_label_required'), 'emplacement_rad_id', array('class' => "control-label") ); ?>
            <div class='controls'>
           	<label class="radio">
            	  <input type="radio" name="emplacement_rad_id" value="1" checked> Beaub'FM
            </label>	
       <span class="help-inline"><?php echo form_error('emplacement_rad_id'); ?></span>
        ...
        <div class="control-group <?php echo form_error('emplacement_emp_plus') ? 'error' : ''; ?>">
         <?php echo form_label('Type d\'emplacement'. lang('bf_form_label_required'), 'emplacement_emp_plus', array('class' => "control-label") ); ?>
            ...
            </label><span class="help-inline"><?php echo form_error('emplacement_emp_plus'); ?></span>
        </div>
        ...
        <div class="control-group <?php echo form_error('emplacement_emp_mail') ? 'error' : ''; ?>">
            ...
            <div class="span3"><textarea rows="10" style="width: 260px;" id="emplacement_emp_mail" name="emplacement_emp_mail"><?php echo set_value('emplacement_emp_mail', isset($emplacement['emp_mail']) ? $emplacement['emp_mail'] : ''); ?></textarea>
        ...
        <div class="form-actions">
            <br/>
            <input type="submit" name="save" class="btn btn-primary" value="Créer un Emplacement" />
