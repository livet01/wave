<div class="admin-box">
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			<thead>
				<tr>
					<?php if ($this->auth->has_permission('Emplacement.Settings.Delete') && isset($records) && is_array($records) && count($records)) : ?>
			...
			<tfoot>
				<?php if ($this->auth->has_permission('Emplacement.Settings.Delete')) : ?>
				<tr>
					<td colspan="5">
			...
			<?php foreach ($records as $record) : ?>
				...
				<?php if ($this->auth->has_permission('Emplacement.Settings.Edit')) : ?>
				<td><?php echo anchor(SITE_AREA .'/settings/emplacement/edit/'. $record->emp_id, '<i class="icon-pencil">&nbsp;</i>' .  $record->emp_libelle) ?></td>
				<?php else: ?>
