...
class developer extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Emplacement.Developer.View');
	...
	*/
	...
	{
		$this->auth->restrict('Emplacement.Developer.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_emplacement())
			{
				...
				Template::redirect(SITE_AREA .'/developer/emplacement');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/developer/emplacement');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Emplacement.Developer.Edit');
		...
		{
			$this->auth->restrict('Emplacement.Developer.Delete');
