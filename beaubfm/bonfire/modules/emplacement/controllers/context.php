...
class context extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Emplacement.Context.View');
	...
	*/
	...
	{
		$this->auth->restrict('Emplacement.Context.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_emplacement())
			{
				...
				Template::redirect(SITE_AREA .'/context/emplacement');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/context/emplacement');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Emplacement.Context.Edit');
		...
		{
			$this->auth->restrict('Emplacement.Context.Delete');
