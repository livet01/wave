...
class reports extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Emplacement.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('Emplacement.Reports.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_emplacement())
			{
				...
				Template::redirect(SITE_AREA .'/reports/emplacement');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/emplacement');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Emplacement.Reports.Edit');
		...
		{
			$this->auth->restrict('Emplacement.Reports.Delete');
