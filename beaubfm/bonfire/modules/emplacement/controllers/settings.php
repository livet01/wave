...
class settings extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Emplacement.Settings.View');
	...
	*/
	...
	{
		$this->auth->restrict('Emplacement.Settings.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_emplacement())
			{
				...
				Template::redirect(SITE_AREA .'/settings/emplacement');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/settings/emplacement');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Emplacement.Settings.Edit');
		...
		{
			$this->auth->restrict('Emplacement.Settings.Delete');
