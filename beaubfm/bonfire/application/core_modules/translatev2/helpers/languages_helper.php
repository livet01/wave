...
if (!function_exists('list_lang_files'))
{
	 ...
	 */
	function list_lang_files($language='french')
	{
		$ci =& get_instance();
		$ci->load->helper('file');
...
if (!function_exists('load_lang_file'))
{
	 ...
	 */
	function load_lang_file($filename=NULL, $language='french')
	{
		if (empty($filename))
		{
			return NULL;
...
if (!function_exists('save_lang_file'))
{
	 ...
	 */
	function save_lang_file($filename=NULL, $language='french', $settings=NULL, $return=FALSE)
	{
