...
<?php if(!has_permission('Wave.Restriction.Disque')) { if(!empty($data['mem_nom'])) { ?><span class="label label-success" style="margin: 0 5px;"><i class="icon-headphones icon-white"></i> <?php echo $data['mem_nom'];?></span><?php } } ?>
<?php if(!has_permission('Wave.Restriction.Disque')) { if(!empty($data['sty_libelle'])) { ?><span class="label label-inverse" style="margin:  0 5px;"><i class="icon-certificate icon-white"></i> <?php echo $data['sty_libelle'];  ?></span><?php } } ?>
...
<?php if(!has_permission('Wave.Restriction.Disque')) { if(!empty($data['col1'])) { ?><span class="label " style="margin:  0 5px;"><i class="icon-plus icon-white"></i> <?php echo $colonne[0];  ?> : <?php echo $data['col1'];  ?></span><?php } ?>
