 ...
 */
class Diffuseur extends \Entities\Diffuseur implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setDifMail($difMail);
    }

    public function getDifMail()
    {
        $this->__load();
        return parent::getDifMail();
    }
    ...
    {
        return array('__isInitialized__', 'perId', 'perNom', 'cat', 'rad', 'utiPrenom', 'utiLogin', 'utiMdp', 'utiTutorial', 'utiVerrou', 'dis', 'difMail');
    }
